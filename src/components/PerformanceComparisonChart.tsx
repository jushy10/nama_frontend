...
// tall, which crushes nine overlapping lines into the lower third; a taller box
  ...
  return (
    <Box ref={wrapRef}>
      {/* Legend: a swatch + label + value-at-cursor + correlation per ticker.
          ...
          the hovered date. The date sits on its own line above so the ticker
          chips wrap into a clean grid rather than around a leading label. */}
      <Box
        sx={{
          color: axis,
          fontSize: '0.78rem',
